...
<li>Model 1 - Model 1 is used to classify images resorting to a pre-trained deep learning model (Inception v3 - convolutional neural network) and uses the ImageNet dataset</li>
